...
declare function setAttrs(values: {[key: string]: string | number | boolean}, options?: {silent?: boolean}, callback?: (values: {[key: string]: string}) => void): void
...
declare function getTranslationByKey(key: string): string | undefined
