...
const warlockData = {	
	...
	careers: [
		// CORE - BASIC
		{name: "agitator",type: "basic",skills: {small_blade: 10,intimidate: 10,persuasion: 12,streetwise: 12, dodge: 12}},
		{name: "beggar",type: "basic",skills: {appraise: 10,blunt: 10,spot: 12,streetwise: 12, lie: 12}},
		{name: "boatman",type: "basic",skills: {navigation: 10,repair: 10,endurance: 12,swimming: 12, blunt: 12}},
		{name: "bodyguard",type: "basic",skills: {medicine: 10,thrown: 10,intimidate: 12,large_blade: 12, dodge: 12}},
		{name: "bounty_hunter",type: "basic",skills: {bargain: 10,crossbow: 10,spot: 12,streetwise: 12, spot: 12}},
		{name: "entertainer",type: "basic",skills: {diplomacy: 10,history: 10,disguise: 12,persuasion: 12, brawling: 12}},
		{name: "footpad",type: "basic",skills: {stealth: 10,thrown: 10,intimidate: 12,streetwise: 12, blunt: 12}},
		{name: "gambler",type: "basic",skills: {bargain: 10,spot: 10,persuasion: 12,"sleight-of-hand": 12, lie: 12}},
		{name: "grave_robber",type: "basic",skills: {intimidate: 10,ostler: 10,small_blade: 12,spot: 12, persuasion: 12}},
		{name: "hunter",type: "basic",skills: {stealth: 10,swimming: 10,spot: 12,survival: 12, bow: 12}},
		{name: "initiate",type: "basic",skills: {command: 10,ostler: 10,medicine: 12,persuasion: 12, incantation: 12}},
		{name: "mercenary",type: "basic",skills: {endurance: 10,streetwise: 10,dodge: 12,large_blade: 12, crossbow: 12}},
		{name: "militiaman",type: "basic",skills: {command: 10,ostler: 10,"pole-arm": 12,thrown: 12, crossbow: 12}},
		{name: "miner",type: "basic",skills: {survival: 10,swimming: 10,endurance: 12,navigation: 12, athletics: 12}},
		{name: "noble",type: "basic",skills: {language: 10,medicine: 10,diplomacy: 12,history: 12, command: 12}},
		{name: "outlaw",type: "basic",skills: {medicine: 10,"sleigh-of-hand": 10,large_blade: 12,thrown: 12, intimidate: 12}},
		{name: "pedlar",type: "basic",skills: {ostler: 10,streetwise: 10,bargain: 12,repair: 12, appraise: 12}},
		{name: "raconteur",type: "basic",skills: {dodge: 10,history: 10,lie: 12,streetwise: 12, appraise: 12}},
		{name: "rat_catcher",type: "basic",skills: {athletics: 10,medicine: 10,stealth: 12,survival: 12, brawling: 12}},
		{name: "road_warden",type: "basic",skills: {crossbow: 10,dodge: 10,"pole-arm": 12,ostler: 12, navigation: 12}},
		{name: "soldier",type: "basic",skills: {command: 10,bow: 10,large_blade: 12,"pole-arm": 12, dodge: 12}},
		{name: "thief",type: "basic",skills: {lie: 10,streetwise: 10,small_blade: 12,spot: 12, "sleight-of-hand": 12}},
		{name: "tomb_robber",type: "basic",skills: {athletics: 10,intimidate: 10,blunt: 12,endurance: 12, appraise: 12}},
		{name: "wizard's_apprentice",type: "basic",skills: {command: 10,persuasion: 10,language: 12,incantation: 12, history: 12}},
		// CORE - ADVANCED
		{name: "assassin",type: "advanced",skills: {blunt: 14,dodge: 14,streetwise: 14,small_blade: 16,stealth: 16, disguise: 16}},
		{name: "bravo",type: "advanced",skills: {blunt: 14,bow: 14,command: 14,large_blade: 16,streetwise: 16, intimidate: 16}},
		{name: "watch_captain",type: "advanced",skills: {crossbow: 14,endurance: 14,ostler: 14,pole_arm: 16,streetwise: 16, command: 16}},
		{name: "charlatan",type: "advanced",skills: {appraise: 14,ostler: 14,spot: 14,persuasion: 16,streetwise: 16, lie: 16}},
		{name: "explorer",type: "advanced",skills: {athletics: 14,small_blade: 14,swimming: 14,navigation: 16,spot: 16, bow: 16}},
		{name: "freelance",type: "advanced",skills: {diplomacy: 14,medicine: 14,thrown: 14,ostler: 16,pole_arm: 16, endurance: 16}},
		{name: "highwayman",type: "advanced",skills: {dodge: 14,intimidate: 14,large_blade: 14,disguise: 16,ostler: 16, crossbow: 16}},
		{name: "mercenary_captain",type: "advanced",skills: {bargain: 14,medicine: 14,survival: 14,crossbow: 16,large_blade: 16, command: 16}},
		{name: "merchant",type: "advanced",skills: {lie: 14,persuasion: 14,sleight_of_hand: 14,appraise: 16,bargain: 16,ostler: 16, appraise: 16}},
		{name: "minstrel",type: "advanced",skills: {history: 14,lie: 14,repair: 14,persuasion: 16,sleight_of_hand: 16, disguise: 16}},
		{name: "outlaw_chief",type: "advanced",skills: {endurance: 14,ostler: 14,swimming: 14,intimidate: 16,large_blade: 16, bow: 16}},
		{name: "priest",type: "advanced",skills: {diplomacy: 14,ostler: 14,thrown: 14,incantation: 16,language: 16, history: 16}},
		{name: "scholar",type: "advanced",skills: {appraise: 14,brawling: 14,repair: 14,language: 16,medicine: 16, history: 16}},
		{name: "scout",type: "advanced",skills: {athletics: 14,ostler: 14,survival: 14,spot: 16,stealth: 16, navigation: 16}},
		{name: "spy",type: "advanced",skills: {athletics: 14,dodge: 14,small_blade: 14,persuasion: 16,sleight_of_hand: 16, disguise: 16}},
		{name: "veteran_soldier",type: "advanced",skills: {dodge: 14,pole_arm: 14,survival: 14,endurance: 16,large_blade: 16, command: 16}},
		{name: "wizard",type: "advanced",skills: {brawling: 14,command: 14,medicine: 14,history: 16,incantation: 16, diplomacy: 16}},
		// COMPENDIUM BASIC
