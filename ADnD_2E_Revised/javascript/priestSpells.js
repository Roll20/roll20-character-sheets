...
pri3['Dispel Magic'] = {
    ...
    'errata': 'Sage Advice #154 p. 6\nSage Advice #214 p. 78\nSage Advice #217 p. 83\nSage Advice #228 p. 84\nSage Advice #231 p. 90\nSage Advice #237 p. 92\nSage Advice #241 p. 16\nSage Advice #245 p. 16\nSage Advice #252 p. 22\nSage Advice #253 p. 24\nSage Advice #273 p. 116\nDungeon Master Option: High-Level Campaigns p. 70\nDungeon Master Option: High-Level Campaigns p. 73',
    'damage': '',
    'damage-type': '',
    'healing': '',
    'effect': '*Dispel magic* has two primary applications, as an **area of effect** or **targeted**. The caster can choose the desired application at the time of casting. When a priest casts this spell, it has a chance to neutralize or negate magic it comes in contact with, as follows:\n&emsp;**Area of effect:** First, it remove spells and spell-like effects (including effects from devices, potions, powers, and innate abilities) from creatures or objects, as well as dispels summoned or conjured creatures. Second, it disrupts spell casting in the area of effect at the instant the dispel is cast, except for innate abilities and powers (such as druid shapeshifting, paladin lay on hands, or turn undead) as these cannot be disrupted. Third, it destroys magical potions (which are treated as 12th level for the purpose of this spell).\n&emsp;Each effect or potion in the spell’s area is checked to determine if it is dispelled. The caster’s own magic is always dispelled; otherwise, the chance to dispel depends on the difference in level between the magical effect and the caster. The base chance is 50% (11 or higher on 1d20 to dispel). If the caster is of higher level than the creator of the effect to be dispelled, the difference is subtracted from the number needed on 1d20 to dispel (making it more likely that the dispel succeeds); if the caster is of lower level, the difference is *added* to the number needed on 1d20 to dispel (making it *less* likely that the dispel succeeds). A roll of 20 always succeeds and a roll of 1 always fails. Thus, if a caster is 10 levels higher than the magic he is trying to dispel, only a roll of 1 prevents the effect from being dispelled.\n&emsp;You dispel all effects and potions at level [[1d20-11+[[@{level-wizard}]] ]] and below!\n&emsp;**Targeted:** A *dispel magic* spell only affects a specially enchanted item–such as a magical scroll, ring, wand, rod, staff, miscellaneous item, weapon, shield, or armor–if it is cast directly upon that item alone. A *dispel magic* spell cast directly upon an unattended magical item automatically renders the item nonoperational for 1d4 rounds. If *dispel magic* is cast upon an item that is in the possession of another creature, the item is unaffected by the dispelling attempt if the creature makes a successful saving throw versus spell. If the creature fails its saving throw, the item is rendered nonoperational for 1d4 rounds. An interdimensional interface (such as a *bag of holding*) rendered nonoperational would be temporarily closed. Note that an item’s physical properties are unchanged: A nonoperational magical sword is still a sword.\n&emsp;**Permanent spell effects:** Spells made permanent with the *permanency* spell must be individually targeted to be dispelled, requiring a separate *dispel magic* for each permanent effect. Unlike a magical item, a permanent spell is destroyed, not temporarily rendered nonoperational, by a successful *dispel magic*. A creature or item never gains a saving throw to avoid a dispelling attempt against its permanent effects, but the *dispel magic* is not automatically successful either. A permanent spell effect cast upon a living creature requires that the caster of the *dispel magic* must be of higher level than the wizard was when he cast the *permanency* spell, and the caster of *dispel magic* must also still make a successful dispelling roll. A permanent spell effect cast upon on an object or area can be dispelled by any caster by making a successful dispelling roll.\n&emsp;Casting *dispel magic* on a creature or object does not radiate an area of effect. Thus, spells such as *stoneskin*, *minor globe of invulnerability* and *barkskin* could not be dispelled as the result of trying to negate the magic of a *wand of lightning*.\n&emsp;**10th-level spells:** A successful *dispel magic* versus a 10th-level spell temporarily negate the spell’s effect for 1d4 rounds. It has no effect against a permanent 10th-level spell cast on a creature.\n&emsp;Artifacts and relics are not subject to this spell; however, some of their spell-like effects may be, at the DM’s option.\n&emsp;Spells and potions whose basic durations are instantaneous cannot be dispelled. A *cure light wounds* spell or *potion of extra-healing*, cannot be dispelled after their healing properties have occurred. *Dispel magic* is also ineffective against petrification from spells such as *flesh to stone* as it is an instantaneous effect, so there is nothing to *dispel*. A *potion of heroism* could be negated while its effects were in operation, however.\n&emsp;Note that this spell can be very effective when used upon charmed and similarly beguiled creatures. Certain spells or effects cannot be dispelled; these are listed in the spell descriptions.\n\n**Summary of *Dispel Magic* Effects**}}{{style=bottom3}}{{cc1-1=bottom}}{{c1-1=**Source of Effect**}}{{c2-1=Caster}}{{c3-1=Other caster/-\n&emsp;innate ability}}{{c4-1=Wand}}{{c5-1=Staff}}{{c6-1=Potion}}{{c7-1=Other magic}}{{c8-1=Artifact}}{{cc1-2=bottom}}{{c1-2=**Resists As**}}{{c2-2=None}}{{c3-2=Leve/HD of\n&emsp;other caster}}{{c4-2=6th level}}{{c5-2=8th level}}{{c6-2=12th level}}{{c7-2=12th, unless special}}{{c8-2=DM discretion}}{{c1-3=**Result of Dispel**}}{{c2-3=Dispel automatic}}{{c3-3=Effect negated}}{{c4-3=&ast;}}{{c5-3=&ast;}}{{c6-3=Potion destroyed}}{{c7-3=&ast;}}{{c8-3=DM discretion}}{{effects2=&ast; Effect negated; if cast directly on item, item becomes nonoperational for 1d4 rounds.',
};
