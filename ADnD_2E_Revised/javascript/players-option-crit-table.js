...
LOCATION_TABLE['Animal'][1] = {'general': 'Legs/Wings', 'specific': 'Right foreleg/wing'};
LOCATION_TABLE['Animal'][2] = {'general': 'Legs/Wings', 'specific': 'Lef t foreleg/wing'};
LOCATION_TABLE['Animal'][3] = {'general': 'Legs/Wings', 'specific': 'Right hind leg'};
LOCATION_TABLE['Animal'][4] = {'general': 'Legs/Wings', 'specific': 'Left hind leg'};
...
LOCATION_TABLE['Monster'][1] = {'general': 'Legs/Wings', 'specific': 'Right foreleg/claw/wing'};
LOCATION_TABLE['Monster'][2] = {'general': 'Legs/Wings', 'specific': 'Left foreleg/claw/wing'};
LOCATION_TABLE['Monster'][3] = {'general': 'Legs/Wings', 'specific': 'Right hind leg'};
LOCATION_TABLE['Monster'][4] = {'general': 'Legs/Wings', 'specific': 'Left hind leg'};
