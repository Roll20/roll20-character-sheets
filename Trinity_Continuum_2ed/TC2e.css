...
@import url('https://fonts.googleapis.com/css?family=Goldman:wght@400;700&display=swap');
...
.customNav-Tabs .nav-tabs {
    border-bottom: 1px solid #ddd;
    transition: 1s;
}

.customNav-Tabs .nav > li > a {
    color: #404040;
    transition: 1s;
}

.customNav-Tabs .nav > li > a[data-tab="charsheet"]{
    color: #555;
    cursor: default;
    background-color: #fff;
...
div.pseudoBody .pseudoDisplay .anima,
div.pseudoBody .pseudoDisplay .sheet-row.anima,
div.pseudoBody .pseudoDisplay .sheet-2colrow.anima,
div.pseudoBody .pseudoDisplay .sheet-3colrow.anima,
...
div.pseudoBody .pseudoDisplay .varg,
div.pseudoBody .pseudoDisplay .sheet-row.varg,
div.pseudoBody .pseudoDisplay .sheet-2colrow.varg,
div.pseudoBody .pseudoDisplay .sheet-3colrow.varg,
div.pseudoBody .pseudoDisplay .varg.default,
div.pseudoBody .pseudoDisplay .sheet-row.varg.default,
div.pseudoBody .pseudoDisplay .sheet-2colrow.varg.default,
div.pseudoBody .pseudoDisplay .sheet-3colrow.varg.default,
div.pseudoBody .pseudoDisplay .equipment,
div.pseudoBody .pseudoDisplay .sheet-row.equipment,
div.pseudoBody .pseudoDisplay .sheet-2colrow.equipment,
div.pseudoBody .pseudoDisplay .sheet-3colrow.equipment,
div.pseudoBody .pseudoDisplay .equipment.default,
div.pseudoBody .pseudoDisplay .sheet-row.equipment.default,
div.pseudoBody .pseudoDisplay .sheet-2colrow.equipment.default,
div.pseudoBody .pseudoDisplay .sheet-3colrow.equipment.default,
div.pseudoBody .pseudoDisplay .subTypeWeapon,
div.pseudoBody .pseudoDisplay .sheet-row.subTypeWeapon,
div.pseudoBody .pseudoDisplay .sheet-2colrow.subTypeWeapon,
div.pseudoBody .pseudoDisplay .sheet-3colrow.subTypeWeapon,
div.pseudoBody .pseudoDisplay .subTypeArmor,
div.pseudoBody .pseudoDisplay .sheet-row.subTypeArmor,
div.pseudoBody .pseudoDisplay .sheet-2colrow.subTypeArmor,
div.pseudoBody .pseudoDisplay .sheet-3colrow.subTypeArmor,
div.pseudoBody .pseudoDisplay .subTypeGear,
div.pseudoBody .pseudoDisplay .sheet-row.subTypeGear,
div.pseudoBody .pseudoDisplay .sheet-2colrow.subTypeGear,
div.pseudoBody .pseudoDisplay .sheet-3colrow.subTypeGear{
	display: none;
}
...
input.selectedTier[value="anima"] ~ .pseudoBody .anima,
input.selectedTier[value="anima"] ~* .pseudoBody .anima{
  display: flex;
}
...
input.selectedTier[value="equipment"] ~ .selectedEquipmentType[value="weapon"] ~ .pseudoBody .subTypeWeapon,
input.selectedTier[value="equipment"] ~ .selectedEquipmentType[value="weapon"] ~* .pseudoBody .subTypeWeapon{
  display: flex;
}


input.selectedTier[value="equipment"] ~ .selectedEquipmentType[value="armor"] ~ .pseudoBody .subTypeArmor,
input.selectedTier[value="equipment"] ~ .selectedEquipmentType[value="armor"] ~* .pseudoBody .subTypeArmor{
  display: flex;
}

input.selectedTier[value="equipment"] ~ .selectedEquipmentType[value="gear"] ~ .pseudoBody .subTypeGear,
input.selectedTier[value="equipment"] ~ .selectedEquipmentType[value="gear"] ~* .pseudoBody .subTypeGear{
  display: flex;
}

input.selectedTier[value="varg"] ~ .pseudoBody .varg,
input.selectedTier[value="varg"] ~* .pseudoBody .varg{
  display: flex;
}

input.selectedTier[value="equipment"] ~ .pseudoBody .equipment,
input.selectedTier[value="equipment"] ~* .pseudoBody .equipment{
  display: flex;
}
...
.pseudoDisplay select.boxPoints{
    font-size: 18px;
    width: auto;
...
.sourceDots .sourceExpended button.dot.rectangle{
    background: white;
    border-style: solid;
    border-width: 1px;
    width: 12px;
...
input.primaryColorFont::placeholder{
    opacity: .5;
}
/* ////////////////  FIM INITIAL COLORS - //////////////// */
...
.colorOverHide[value="default"] ~* .logoAnima,
...
.colorOverHide[value="default"] + .selectedTier[value="ftech"] ~* .logoTalent{
 ...
 .colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .logoPsion,
 .colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .logoPsion{
    opacity: 1;
    z-index: 1;
    transition: opacity 1s;
 }
 ...
 .colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .logoAnima{
    opacity: 1;
    z-index: 1;
    transition: opacity 1s;
 }
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .primaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tertiaryColorBackground,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~* .primaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~* .secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~* .tertiaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~* .colorFont

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~* .primaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~* .secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~* .tertiaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~* .colorFont{
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~ .pseudoDisplay,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~ .pseudoDisplay,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .primaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .customRepeating > .repcontrol,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .primaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .customRepeating > .repcontrol,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .secondaryColorBackground,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .secondaryColorBackground,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .tertiaryColorBackground,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .tertiaryColorBackground,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .colorFont,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .colorFont,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="hard"] ~* .arena.central,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="hard"] ~* .arena.central,
...
.colorOverHide[value="default"] + .selectedTier[value="baseline"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="neutral"] ~* input[type="checkbox"]:checked{
    background-color: #848484;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="talent"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="ftech"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="flux"] ~* .primaryColorFont::placeholder{
    color: #005B7F;
}
...
.colorOverHide[value="default"] + .selectedTier[value="talent"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="ftech"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="flux"] ~* input[type="checkbox"]:checked{
    background-color: #2485AC;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="nova"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="superior"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="qtech"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="quantum"] ~* .primaryColorFont::placeholder{
    color: black;
}



.colorOverHide[value="default"] + .selectedTier[value="nova"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="nova"] ~* .arena.central,

.colorOverHide[value="default"] + .selectedTier[value="superior"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="superior"] ~* .arena.central,

.colorOverHide[value="default"] + .selectedTier[value="qtech"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="qtech"] ~* .arena.central,
...
.colorOverHide[value="default"] + .selectedTier[value="nova"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="superior"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="qtech"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="quantum"] ~* input[type="checkbox"]:checked{
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~ .pseudoDisplay,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~ .pseudoDisplay,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .secondaryColorBackground,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .secondaryColorBackground,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .colorFont,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .colorFont,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .primaryColorFont,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .primaryColorFont,

.colorOverHide[value="psi"] ~* .primaryColorFont,

colorOverHide[value="default"] + .selectedTier[value="psion"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="psiad"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="transport"] ~ .selectedTech[value="noetic"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="psi"] ~* .primaryColorFont::placeholder{
    color: #A5181C;
}
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .arena.central,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .arena.central,
...
.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* .rollEndingSectionInner.tertiaryColorBackground,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* .rollEndingSectionInner.tertiaryColorBackground,

.colorOverHide[value="psi"] ~* .rollEndingSectionInner.tertiaryColorBackground{
    background-color:#CA543D;
}



.colorOverHide[value="default"] + .selectedTier[value="psion"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="psiad"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="transport"] ~ .selectedTech[value="noetic"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="varg"] ~ .selectedTech[value="noetic"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="default"] + .selectedTier[value="equipment"] ~ .selectedTech[value="noetic"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="psi"] ~* input[type="checkbox"]:checked{
    background-color: #c83c20;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="NPC"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="source"] ~* .primaryColorFont::placeholder{
    color: #80407E;
}
...
.colorOverHide[value="default"] + .selectedTier[value="NPC"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="source"] ~* input[type="checkbox"]:checked{
    background-color: #a465a1;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="inspired"] ~* .aptitude,
...
.colorOverHide[value="default"] + .selectedTier[value="inspired"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="vintage"] ~* input[type="checkbox"]:checked{
    background-color: #676561;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .customRoll .defaultRollingDisplay.singleCustomRoll,

.colorOverHide[value="fulgurtech"] ~* .customRoll .defaultRollingDisplay.singleCustomRoll{
    font-family: oxanium;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .custominitiative .defaultRollingDisplay.singleCustomRoll,

.colorOverHide[value="fulgurtech"] ~* .custominitiative .defaultRollingDisplay.singleCustomRoll{
    font-family: oxanium;
} 


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* select option,

.colorOverHide[value="fulgurtech"] ~* select option{   
    background: #001715;
    color: #24dbd6;  
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* select option:hover,

.colorOverHide[value="fulgurtech"] ~* select option:hover{   
    background: #001715;
    color: #24dbd552;  
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .readerTrait .tier .inputLine option.optionTitle,

.colorOverHide[value="fulgurtech"] ~* .readerTrait .tier .inputLine option.optionTitle{   
    background: #00fff8;
    color: #001715;
    font-weight: 600;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tier .inputLine option:disabled,

.colorOverHide[value="fulgurtech"] ~* .tier .inputLine option:disabled{
    color: #24dbd691;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ .pseudoBody .pseudoDisplay .customRoll .defaultRollingDisplay option,

.colorOverHide[value="fulgurtech"] ~ .pseudoBody .pseudoDisplay .customRoll .defaultRollingDisplay option{   
    background: #001715;
    color: #24dbd6;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ .customNav-Tabs,

.colorOverHide[value="fulgurtech"] ~ .customNav-Tabs{   
    background: black; 
    transition: 1s;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ .customNav-Tabs .nav-tabs,

.colorOverHide[value="fulgurtech"] ~ .customNav-Tabs .nav-tabs{
    border-color: #41fcf6;
    transition: 1s;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ .customNav-Tabs .nav > li > a,

.colorOverHide[value="fulgurtech"] ~ .customNav-Tabs .nav > li > a{
    color: #298e8b;
    transition: 1s;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ .customNav-Tabs .nav > li > a[data-tab="charsheet"],

.colorOverHide[value="fulgurtech"] ~ .customNav-Tabs .nav > li > a[data-tab="charsheet"]{
    color: #000000;
    cursor: default;
    background-color: #59fffa;
    border: 1px solid #59fffa;
...
.ui-dialog .charsheet .colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontainer .repitem .itemcontrol,

.ui-dialog .charsheet .colorOverHide[value="fulgurtech"] ~ * .repcontainer .repitem .itemcontrol {
    background-color: rgba(0, 255, 246, 0.24);
}



.ui-dialog .charsheet .colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontrol_move,
.ui-dialog .charsheet .colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontrol_del,

.ui-dialog .charsheet .colorOverHide[value="fulgurtech"] ~* .repcontrol_move,
.ui-dialog .charsheet .colorOverHide[value="fulgurtech"] ~* .repcontrol_del{
    border-radius: 0;
...
.ui-dialog .charsheet .colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontrol_del::before,

.ui-dialog .charsheet .colorOverHide[value="fulgurtech"] ~* .repcontrol_del::before{
    content: "delete";
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ .pseudoBody,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pseudoNav button,

.colorOverHide[value="fulgurtech"] ~ .pseudoBody,
.colorOverHide[value="fulgurtech"] ~* .pseudoNav button {   
    background: black;  
    transition: background-color 1s;
    color: #00bdb3;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="sheet"] ~* button[name="act_sheet"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="equipments"] ~* button[name="act_equipments"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="rolls"] ~* button[name="act_rolls"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="combatMode"] ~* button[name="act_combatMode"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="creationMode"] ~* button[name="act_creationMode"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="settings"] ~* button[name="act_settings"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .tabstoggle[value="credits"] ~* button[name="act_credits"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pseudoDisplay,

.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="sheet"] ~* button[name="act_sheet"],
.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="equipments"] ~* button[name="act_equipments"],
.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="rolls"] ~* button[name="act_rolls"],
.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="combatMode"] ~* button[name="act_combatMode"],
.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="creationMode"] ~* button[name="act_creationMode"],
.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="settings"] ~* button[name="act_settings"],
.colorOverHide[value="fulgurtech"] ~* .tabstoggle[value="credits"] ~* button[name="act_credits"],
.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay{
    border-color: #008D88;
...
.colorOverHide[value="fulgurtech"] ~* .logoAnima{
    display: block;
    position: absolute;
    opacity: 1;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .expanderFlagModal[value="1"] ~ .modalBackground,

.colorOverHide[value="fulgurtech"] ~* .expanderFlagModal[value="1"] ~ .modalBackground{
    background-color: black;
    opacity: 0.8;
} 


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input[type="checkbox"],

.colorOverHide[value="fulgurtech"] ~* input[type="checkbox"]{
    border-color: #00bdb7;
    border-radius: 0;
    background: transparent;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input[type="checkbox"]::before,

.colorOverHide[value="fulgurtech"] ~* input[type="checkbox"]::before{
    background-color: black;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input[type="checkbox"]:checked,

.colorOverHide[value="fulgurtech"] ~* input[type="checkbox"]:checked{
    background-color: #00fff7;
    border-color: #00fff7;
}

.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * input::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ input::placeholder,

.colorOverHide[value="fulgurtech"] ~ * input::placeholder,
.colorOverHide[value="fulgurtech"] ~ input::placeholder{
    color: #00FFF6;
    opacity: .5;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * input,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ input,

.colorOverHide[value="fulgurtech"] ~ * input,
.colorOverHide[value="fulgurtech"] ~ input{
    color: #00FFF6;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .summaryButtons span.secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .summaryButtons div a.secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .rollButtons .secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .rollButtons .secondaryColorBackground input,

.colorOverHide[value="fulgurtech"] ~* .summaryButtons span.secondaryColorBackground,
.colorOverHide[value="fulgurtech"] ~* .summaryButtons div a.secondaryColorBackground,
.colorOverHide[value="fulgurtech"] ~* .rollButtons .secondaryColorBackground,
.colorOverHide[value="fulgurtech"] ~* .rollButtons .secondaryColorBackground input{
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .summaryButtons span.secondaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .rollButtons span,

.colorOverHide[value="fulgurtech"] ~* .summaryButtons span.secondaryColorBackground,
.colorOverHide[value="fulgurtech"] ~* .rollButtons span{
    color: #001715;
    font-weight: 500;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .primaryColorBackground,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .customRepeating > .repcontrol,
...
.colorOverHide[value="fulgurtech"] ~* .secondaryColorBackground{
...
.colorOverHide[value="fulgurtech"] ~* .tertiaryColorBackground{
    background-color: #001715;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .colorFont,

.colorOverHide[value="fulgurtech"] ~* .colorFont{
    color: #59FFFA;
    transition: 1s;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .primaryColorFont,

.colorOverHide[value="fulgurtech"] ~* .primaryColorFont{
    color: #41FCF6;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .primaryColorFont::placeholder,

.colorOverHide[value="fulgurtech"] ~* .primaryColorFont::placeholder{
    color: #41FCF6;
    opacity: 0.5;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .arenas,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaArenas,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .arena.central,

.colorOverHide[value="fulgurtech"] ~* .arenas,
.colorOverHide[value="fulgurtech"] ~* .megaArenas,
.colorOverHide[value="fulgurtech"] ~* .arena.central{
    outline-color: #27A09B;
    border-color: #27A09B;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .dots,

.colorOverHide[value="fulgurtech"] ~* .dots{
    margin-right: 6px;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay button.dot{
    width: 5px;
    height: 5px;
    margin-top: 7px;
    margin-left: 7px;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot > span,

.colorOverHide[value="fulgurtech"] ~* button.dot > span{
    min-width: 8px;
    height: 14px;
    margin-top: -8px;         
}
...
.colorOverHide[value="fulgurtech"] ~* button.dot > span{
    left: 0px;
    background: #86F7F3;
    box-shadow: 0px 0px 13px #0FFFF796;
    transition: none; 
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot.gt-5 > span,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot.gt-6 > span,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot.gt-7 > span,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot.gt-8 > span,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot.gt-9 > span,

.colorOverHide[value="fulgurtech"] ~* button.dot.gt-5 > span,
.colorOverHide[value="fulgurtech"] ~* button.dot.gt-6 > span,
.colorOverHide[value="fulgurtech"] ~* button.dot.gt-7 > span,
.colorOverHide[value="fulgurtech"] ~* button.dot.gt-8 > span,
.colorOverHide[value="fulgurtech"] ~* button.dot.gt-9 > span{
    height: 14px;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* button.dot::before,

.colorOverHide[value="fulgurtech"] ~* button.dot::before{
    display: none;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .hexagon, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .hexagon::before, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .hexagon > span,

.colorOverHide[value="fulgurtech"] ~* .hexagon, 
.colorOverHide[value="fulgurtech"] ~* .hexagon::before, 
.colorOverHide[value="fulgurtech"] ~* .hexagon > span{
    clip-path: unset;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="0"] ~ button.gt-0 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="1"] ~ button.gt-1 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="2"] ~ button.gt-2 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="3"] ~ button.gt-3 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="4"] ~ button.gt-4 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="5"] ~ button.gt-5 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="6"] ~ button.gt-6 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="7"] ~ button.gt-7 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="8"] ~ button.gt-8 > span.checked,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* input.dot[value="9"] ~ button.gt-9 > span.checked,

.colorOverHide[value="fulgurtech"] ~* input.dot[value="0"] ~ button.gt-0 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="1"] ~ button.gt-1 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="2"] ~ button.gt-2 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="3"] ~ button.gt-3 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="4"] ~ button.gt-4 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="5"] ~ button.gt-5 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="6"] ~ button.gt-6 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="7"] ~ button.gt-7 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="8"] ~ button.gt-8 > span.checked,
.colorOverHide[value="fulgurtech"] ~* input.dot[value="9"] ~ button.gt-9 > span.checked{
    transform: scale(1);
    transition: none;
    opacity: 0; 
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .sourceDots button.dot,

.colorOverHide[value="fulgurtech"] ~* .sourceDots button.dot{
    margin-left: 0px;
    margin-right: 0px;
    width: 23px;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .sourceDots .sourceExpended button.dot.rectangle,

.colorOverHide[value="fulgurtech"] ~* .sourceDots .sourceExpended button.dot.rectangle{
    border: solid 1px #009D97;
    background: transparent; 
    height: 5px;
    margin-top: 7px;   
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .sourceDots button.dot > span,

.colorOverHide[value="fulgurtech"] ~* .sourceDots button.dot > span{
    min-width: 25px;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .space1,

.colorOverHide[value="fulgurtech"] ~* .space1 {
    margin-bottom: 35px;
    transition: 1s;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .input-label,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .divisorLabel,

.colorOverHide[value="fulgurtech"] ~* .input-label,
.colorOverHide[value="fulgurtech"] ~* .divisorLabel,
.colorOverHide[value="fulgurtech"] ~* .powerTypeExtension div,
.colorOverHide[value="fulgurtech"] ~ * .quantumPowerTypeAndExpander .powerTypeExtension .inputPathName[name="attr_powertypeextension-1"], 
.colorOverHide[value="fulgurtech"] ~ * .quantumPowerTypeAndExpander .powerTypeExtension .inputPathName[name="attr_powertypeextension-2"] {    
    color: #41FCF6;
    transition: 1s;    
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pseudoDisplay .inputLine,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pseudoDisplay .secondaryColorBackground .megaAttributesTag .inputLine,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .inputLine,
.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .secondaryColorBackground .megaAttributesTag .inputLine,
.colorOverHide[value="fulgurtech"] ~* .aptitudeModes .aptitudeModeLevelsContainer .traitHeader .inputLine,
.colorOverHide[value="fulgurtech"] ~* .auxiliaryMode .aptitudeModeLevelsContainer .traitHeader .inputLine,
.colorOverHide[value="fulgurtech"] ~* .aptitudeModes .aptitudeProxyLevelsContainer .traitHeader .inputLine{    
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputLine::placeholder,

.colorOverHide[value="fulgurtech"] ~* .inputLine::placeholder{    
    color: #24DBD6;
    opacity: 0.5;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .title,

.colorOverHide[value="fulgurtech"] ~* .title{
    font-family: goldman;
    font-weight: bold;
    font-size: 35px;
    transition: 1s;
    color: #41FCF6;
    border: 1px solid #41FCF6;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .customRepeating .title,

.colorOverHide[value="fulgurtech"] ~* .customRepeating .title{
   border-right: none;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .title2,

.colorOverHide[value="fulgurtech"] ~* .title2{
    font-family: goldman;
    font-weight: bold;
    font-size: 30px;
    transition: 1s;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .customRepeating .title2,

.colorOverHide[value="fulgurtech"] ~* .customRepeating .title2{
   border-right: none;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .selectableTitle .title2,

.colorOverHide[value="fulgurtech"] ~* .selectableTitle .title2{
    border-left: none;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .transcendence.selectableTitle .title2 .inputTitle,

.colorOverHide[value="fulgurtech"] ~* .transcendence.selectableTitle .title2 .inputTitle{
    width: 90%;
    margin-right: 10%;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .customRepeating .repcontrol,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .titleSelectInputContainer,

.colorOverHide[value="fulgurtech"] ~* .customRepeating .repcontrol,
.colorOverHide[value="fulgurtech"] ~* .titleSelectInputContainer{
    transition: 1s;
    color: #41FCF6;
    border-color: #41FCF6;    
}

.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .changeTitleIcon, 

.colorOverHide[value="fulgurtech"] ~* .changeTitleIcon{
    color: #41FCF6;
}    



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontrol .repcontrol_edit,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontrol .repcontrol_add,

.colorOverHide[value="fulgurtech"] ~* .repcontrol .repcontrol_edit,
.colorOverHide[value="fulgurtech"] ~* .repcontrol .repcontrol_add{    
    color: #41FCF6;    
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* textarea,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay textarea{   
    color: #28ccc7;
    border-color: #008d88;
    border-radius: 0px;
    background-color: #0bf0dd00; 
    scrollbar-color: #59fffa #1ca8a445;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* textarea::placeholder,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay textarea::placeholder{   
    color: #28ccc7;
    opacity: .5;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pseudoDisplay .boxPoints,
.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .boxPoints{
   border: none;   
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .boxPoints input,
.colorOverHide[value="fulgurtech"] ~* .anima .boxPoints input{
    padding-top: 1px;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .skills .title,

.colorOverHide[value="fulgurtech"] ~* .skills .title{
   font-size: 40px;
   transition: 1s;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkill,

.colorOverHide[value="fulgurtech"] ~* .animaSkill{
    border-color: #008D88;
    background: #001715;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkillHeader,

.colorOverHide[value="fulgurtech"] ~* .animaSkillHeader{
    color: #6BFFF9;
    text-shadow: 0px 0px 10px #00E2FDBF;
    border-bottom: 1px solid #008D88;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkillEnhacName,

.colorOverHide[value="fulgurtech"] ~* .animaSkillEnhacName{
    color: #06EAE2;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkillEnhac .line,
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .line,

.colorOverHide[value="fulgurtech"] ~* .line{
    border-color: #00403E;    
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkillEnhacNumber,

.colorOverHide[value="fulgurtech"] ~* .animaSkillEnhacNumber{
    background-color: #00403E;   
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkillEnhacNumber input,

.colorOverHide[value="fulgurtech"] ~* .animaSkillEnhacNumber.boxPoints input{
    color: #00FFF6; 
    font-weight: initial;   
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaSkillEnhacNumber input::placeholder,

.colorOverHide[value="fulgurtech"] ~* .animaSkillEnhacNumber.boxPoints input::placeholder{
    color: #00FFF6; 
    opacity: .5;
    font-weight: initial;   
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .boxPoints .boxPoint input,

.colorOverHide[value="fulgurtech"] ~* .anima .boxPoints .boxPoint input{
    padding-top: 1px;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground,

.colorOverHide[value="fulgurtech"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground{
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .animaHealth .boxPoints .boxPoint .boxPointsTitle,

.colorOverHide[value="fulgurtech"] ~* .anima .animaHealth .boxPoints .boxPoint .boxPointsTitle{
    font-family: goldman;
    font-weight: bold;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground .boxPointsTitle,

.colorOverHide[value="fulgurtech"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground .boxPointsTitle{
    color: black;
    font-size: 10px;
    font-family: goldman;
    font-weight: bold;    
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground input,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground input::placeholder,

.colorOverHide[value="fulgurtech"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground input,
.colorOverHide[value="fulgurtech"] ~* .anima .animaHealth .boxPoints .boxPoint.secondaryColorBackground input::placeholder{
    color: black; 
    opacity: 1; 
    font-weight: bold;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .boxPoint.animaDefense,

.colorOverHide[value="fulgurtech"] ~* .anima .boxPoint.animaDefense{
    background: #001715;
    border: 1px solid #41FCF6;
    width: 69px;
    height: 49px;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .boxPoint.animaDefense .boxPointsTitle,

.colorOverHide[value="fulgurtech"] ~* .anima .boxPoint.animaDefense .boxPointsTitle{
    font-size: 10px;
    color: #41FCF6;
    opacity: 1;    
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .anima .animaHealth .boxPoint.animaDefense input::placeholder,

.colorOverHide[value="fulgurtech"] ~* .anima .animaHealth .boxPoint.animaDefense input::placeholder{
     opacity: 1;    
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCAnimaAspects,

.colorOverHide[value="fulgurtech"] ~* .TCAnimaAspects{
    margin-top: 12px;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCAnimaAspects .title2 .titleLabel,
.colorOverHide[value="fulgurtech"] ~* .TCAnimaAspects .title2 .titleLabel{
    font-size: 35px;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathLabel,

.colorOverHide[value="fulgurtech"] ~* .pathLabel{
  background-color: #41FCF6;
  color: black;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .spanExpander,

.colorOverHide[value="fulgurtech"] ~* .spanExpander{
    color: #008D88;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .quantumPower .inputPathName:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleWeapon .weaponHeader .inputWeaponName:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleArmor .weaponHeader .inputWeaponName:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .names input:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .traitName:placeholder-shown,

.colorOverHide[value="fulgurtech"] ~ * .quantumPower .inputPathName:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponName:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponName:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~ * .defaultRollingDisplay.singleCustomRoll .names input:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~ * .defaultRollingDisplay.singleCustomRoll .traitName:placeholder-shown{	
	border-bottom: 1px solid #00D0C9;	
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPower .inputPathName:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdge .inputPathName:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .superiorPower .inputPathName:placeholder-shown,

.colorOverHide[value="fulgurtech"] ~* .quantumPower .inputPathName:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~* .megaEdge .inputPathName:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~* .superiorPower .inputPathName:placeholder-shown{
    background-color: transparent;    
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPowerTabButtons button,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdgeTabButtons button,

.colorOverHide[value="fulgurtech"] ~* .quantumPowerTabButtons button,
.colorOverHide[value="fulgurtech"] ~* .megaEdgeTabButtons button{
    color: #41fcf6ad;
}    
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPowerTabsToggle[value="quantum-power-1-traits"] ~ * button[name="act_quantum-power-1-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPowerTabsToggle[value="quantum-power-1-description"] ~ * button[name="act_quantum-power-1-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPowerTabsToggle[value="quantum-power-2-traits"] ~ * button[name="act_quantum-power-2-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPowerTabsToggle[value="quantum-power-2-description"] ~ * button[name="act_quantum-power-2-description"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdgeTabsToggle[value="mega-edge-1-traits"] ~ * button[name="act_mega-edge-1-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdgeTabsToggle[value="mega-edge-1-description"] ~ * button[name="act_mega-edge-1-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdgeTabsToggle[value="mega-edge-2-traits"] ~ * button[name="act_mega-edge-2-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdgeTabsToggle[value="mega-edge-2-description"] ~ * button[name="act_mega-edge-2-description"],

.colorOverHide[value="fulgurtech"] ~* .quantumPowerTabsToggle[value="quantum-power-1-traits"] ~ * button[name="act_quantum-power-1-traits"], 
.colorOverHide[value="fulgurtech"] ~* .quantumPowerTabsToggle[value="quantum-power-1-description"] ~ * button[name="act_quantum-power-1-description"], 
.colorOverHide[value="fulgurtech"] ~* .quantumPowerTabsToggle[value="quantum-power-2-traits"] ~ * button[name="act_quantum-power-2-traits"], 
.colorOverHide[value="fulgurtech"] ~* .quantumPowerTabsToggle[value="quantum-power-2-description"] ~ * button[name="act_quantum-power-2-description"],
.colorOverHide[value="fulgurtech"] ~* .megaEdgeTabsToggle[value="mega-edge-1-traits"] ~ * button[name="act_mega-edge-1-traits"], 
.colorOverHide[value="fulgurtech"] ~* .megaEdgeTabsToggle[value="mega-edge-1-description"] ~ * button[name="act_mega-edge-1-description"], 
.colorOverHide[value="fulgurtech"] ~* .megaEdgeTabsToggle[value="mega-edge-2-traits"] ~ * button[name="act_mega-edge-2-traits"], 
.colorOverHide[value="fulgurtech"] ~* .megaEdgeTabsToggle[value="mega-edge-2-description"] ~ * button[name="act_mega-edge-2-description"]{
    background-color: #001715;
    border-color: #008D88;  
    color: #41FCF6; 
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .pathTabContent,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .quantumPowerTabContent,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .megaEdgeTabContent,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponTabContent,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .rollMiddleSection1,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .cRDescriptionTab,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .circumstExpanded,

.colorOverHide[value="fulgurtech"] ~ * .quantumPowerTabContent,
.colorOverHide[value="fulgurtech"] ~ * .megaEdgeTabContent,
.colorOverHide[value="fulgurtech"] ~ * .weaponTabContent,
.colorOverHide[value="fulgurtech"] ~ * .pathTabContent,
.colorOverHide[value="fulgurtech"] ~ * .defaultRollingDisplay.singleCustomRoll .rollMiddleSection1,
.colorOverHide[value="fulgurtech"] ~ * .cRDescriptionTab,
.colorOverHide[value="fulgurtech"] ~ * .circumstExpanded,
.colorOverHide[value="fulgurtech"] ~ * .basic-modeExpandedArea,
.colorOverHide[value="fulgurtech"] ~ * .aptitudeModeLevelsContainer,
.colorOverHide[value="fulgurtech"] ~ * .aptitudeProxyLevel .aptitudeProxyLevelsContainer{
    background: #001715;
    border-color: #008d88;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .expanderFlagModal[value="1"] ~ .traitHeader, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .expanderFlagModal[value="1"] ~ .expandedArea,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .repcontainer .singlePathContact .expanderFlagModal[value="1"] ~ .expandedArea

.colorOverHide[value="fulgurtech"] ~* .expanderFlagModal[value="1"] ~ .traitHeader, 
.colorOverHide[value="fulgurtech"] ~* .expanderFlagModal[value="1"] ~ .expandedArea,
.colorOverHide[value="fulgurtech"] ~* .repcontainer .singlePathContact .expanderFlagModal[value="1"] ~ .expandedArea{
    z-index: 3;
    background: #001715;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPowerTagsContainer,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdgeTagsContainer,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .defaultRollingDisplay .customRollExpandedArea .rollMiddleSection2,

.colorOverHide[value="fulgurtech"] ~* .quantumPowerTagsContainer,
.colorOverHide[value="fulgurtech"] ~* .megaEdgeTagsContainer,
.colorOverHide[value="fulgurtech"] ~* .defaultRollingDisplay .customRollExpandedArea .rollMiddleSection2,
.colorOverHide[value="fulgurtech"] ~* .aptitudeModeExpandedArea{
    height: 263px;
    padding-top: 2px;
    border-color: #008d88;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCAnimaAspects .quantumPowerTagsContainer,

.colorOverHide[value="fulgurtech"] ~* .TCAnimaAspects .quantumPowerTagsContainer{
    height: 165px;
} 
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .quantumPower,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .megaEdge,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .superiorPower,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .singlePath,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleWeapon,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleArmor,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleCustomRoll,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleCustomRoll .rollTitleSectionInner,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .rollEndingSection,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ *  .TCCombatMode .TCcircumst .singleCircumst,

.colorOverHide[value="fulgurtech"] ~* .quantumPower,
.colorOverHide[value="fulgurtech"] ~* .megaEdge,
.colorOverHide[value="fulgurtech"] ~* .superiorPower,
.colorOverHide[value="fulgurtech"] ~* .singlePath,
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon,
.colorOverHide[value="fulgurtech"] ~ * .singleArmor,
.colorOverHide[value="fulgurtech"] ~ * .singleCustomRoll,
.colorOverHide[value="fulgurtech"] ~ * .singleCustomRoll .rollTitleSectionInner,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay .rollEndingSection,
.colorOverHide[value="fulgurtech"] ~ * .TCCombatMode .TCcircumst .singleCircumst,
.colorOverHide[value="fulgurtech"] ~ * .basicMode,
.colorOverHide[value="fulgurtech"] ~ * .aptitudeModes .secondaryColorBackground,
.colorOverHide[value="fulgurtech"] ~ * .auxiliaryMode{
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputPathName:hover, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputPathName:active, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputPathName:focus, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputPathName:placeholder-shown,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponTitle:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponTitle:active, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponTitle:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleWeapon .weaponHeader .inputWeaponName:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleWeapon .weaponHeader .inputWeaponName:active, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleWeapon .weaponHeader .inputWeaponName:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleArmor .weaponHeader .inputWeaponName:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleArmor .weaponHeader .inputWeaponName:active, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleArmor .weaponHeader .inputWeaponName:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponEnhancement:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponEnhancement:active, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponEnhancement:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input:active,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber:active,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue:hover, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue:active, 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName:active,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName:focus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber:hover,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber:active,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber:focus,

.colorOverHide[value="fulgurtech"] ~* .inputPathName:hover, 
.colorOverHide[value="fulgurtech"] ~* .inputPathName:active, 
.colorOverHide[value="fulgurtech"] ~* .inputPathName:focus, 
.colorOverHide[value="fulgurtech"] ~* .inputPathName:placeholder-shown,
.colorOverHide[value="fulgurtech"] ~ * .inputWeaponTitle:hover,
.colorOverHide[value="fulgurtech"] ~ * .inputWeaponTitle:active, 
.colorOverHide[value="fulgurtech"] ~ * .inputWeaponTitle:focus,
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponName:hover,
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponName:active, 
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponName:focus,
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponEnhancement:hover,
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponEnhancement:active, 
.colorOverHide[value="fulgurtech"] ~ * .singleWeapon .weaponHeader .inputWeaponEnhancement:focus,
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponName:hover,
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponName:active, 
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponName:focus,
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponEnhancement:hover,
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponEnhancement:active, 
.colorOverHide[value="fulgurtech"] ~ * .singleArmor .weaponHeader .inputWeaponEnhancement:focus,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input:hover,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input:active,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input:focus,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber:hover,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber:active,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber:focus,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue:hover, 
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue:active, 
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue:focus,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName:hover,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName:active,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName:focus,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber:hover,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber:active,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber:focus,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .inputAptitudeauxiliaryModeName,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .inputAptitudeauxiliaryModeName:hover,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .inputAptitudeauxiliaryModeName:active,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .inputAptitudeauxiliaryModeName:focus,
.colorOverHide[value="fulgurtech"] ~ .pseudoBody .pseudoDisplay .headerStatsWeaponType input:hover,
.colorOverHide[value="fulgurtech"] ~ .pseudoBody .pseudoDisplay .headerStatsWeaponType input:active,
.colorOverHide[value="fulgurtech"] ~ .pseudoBody .pseudoDisplay .headerStatsWeaponType input:focus{
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathStatus,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .pathStatus{
  background-color: #41FCF6;
  color: #002f2d;
  font-weight: bold;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCPaths input.selectedPathStatus[value="suspended"] + .singlePath .pathStatus,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath .pathStatus,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .TCPaths input.selectedPathStatus[value="suspended"] + .singlePath .pathStatus,
.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath .pathStatus{
    color: #41fcf6;
    background: #002f2c;
    border-color: #008d88;
    transition: 1s;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath{
    background-color: #001715;
    transition: 1s;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath .pathLabel,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath .pathLabel{
    background: #001715;
    color: #41fcf6;
    border: 1px solid #008d88;
  }
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabButtons button,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabButtons button,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .defaultRollingDisplay.singleCustomRoll .cRTabButtons button,

.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .pathTabButtons button,
.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .weaponTabButtons button,
.colorOverHide[value="fulgurtech"] ~* .pseudoDisplay .defaultRollingDisplay.singleCustomRoll .cRTabButtons button{
    color: #41fcf6ad;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="origin-connections"] ~* button[name="act_origin-connections"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="role-connections"] ~* button[name="act_role-connections"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="society-connections"] ~* button[name="act_society-connections"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-1-connections"] ~* button[name="act_extraPath-1-connections"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-2-connections"] ~* button[name="act_extraPath-2-connections"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="origin-skills"] ~* button[name="act_origin-skills"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="role-skills"] ~* button[name="act_role-skills"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="society-skills"] ~* button[name="act_society-skills"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-1-skills"] ~* button[name="act_extraPath-1-skills"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-2-skills"] ~* button[name="act_extraPath-2-skills"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="origin-edges"] ~* button[name="act_origin-edges"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="role-edges"] ~* button[name="act_role-edges"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="society-edges"] ~* button[name="act_society-edges"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-1-edges"] ~* button[name="act_extraPath-1-edges"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-2-edges"] ~* button[name="act_extraPath-2-edges"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="origin-story"] ~* button[name="act_origin-story"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="role-story"] ~* button[name="act_role-story"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="society-story"] ~* button[name="act_society-story"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-1-story"] ~* button[name="act_extraPath-1-story"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pathTabsToggle[value="extraPath-2-story"] ~* button[name="act_extraPath-2-story"],

.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabsToggle[value="weapon1-traits"] ~ * button[name="act_weapon1-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabsToggle[value="weapon2-traits"] ~ * button[name="act_weapon2-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabsToggle[value="weapon3-traits"] ~ * button[name="act_weapon3-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabsToggle[value="weapon1-description"] ~ * button[name="act_weapon1-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabsToggle[value="weapon2-description"] ~ * button[name="act_weapon2-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .weaponTabsToggle[value="weapon3-description"] ~ * button[name="act_weapon3-description"],

.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .armorTabsToggle[value="armor1-traits"] ~ * button[name="act_armor1-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .armorTabsToggle[value="armor2-traits"] ~ * button[name="act_armor2-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .armorTabsToggle[value="armor3-traits"] ~ * button[name="act_armor3-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .armorTabsToggle[value="armor1-description"] ~ * button[name="act_armor1-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .armorTabsToggle[value="armor2-description"] ~ * button[name="act_armor2-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .armorTabsToggle[value="armor3-description"] ~ * button[name="act_armor3-description"],

.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cRTabsToggle[value="cr01-traits"] ~ * button[name="act_cr01-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cRTabsToggle[value="cr02-traits"] ~ * button[name="act_cr02-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cRTabsToggle[value="cr03-traits"] ~ * button[name="act_cr03-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cRTabsToggle[value="cr01-description"] ~ * button[name="act_cr01-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cRTabsToggle[value="cr02-description"] ~ * button[name="act_cr02-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cRTabsToggle[value="cr03-description"] ~ * button[name="act_cr03-description"],

.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cITabsToggle[value="ci01-traits"] ~ * button[name="act_ci01-traits"],
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cITabsToggle[value="ci02-traits"] ~ * button[name="act_ci02-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cITabsToggle[value="ci03-traits"] ~ * button[name="act_ci03-traits"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cITabsToggle[value="ci01-description"] ~ * button[name="act_ci01-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cITabsToggle[value="ci02-description"] ~ * button[name="act_ci02-description"], 
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .cITabsToggle[value="ci03-description"] ~ * button[name="act_ci03-description"],

.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="origin-connections"] ~* button[name="act_origin-connections"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="role-connections"] ~* button[name="act_role-connections"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="society-connections"] ~* button[name="act_society-connections"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-1-connections"] ~* button[name="act_extraPath-1-connections"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-2-connections"] ~* button[name="act_extraPath-2-connections"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="origin-skills"] ~* button[name="act_origin-skills"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="role-skills"] ~* button[name="act_role-skills"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="society-skills"] ~* button[name="act_society-skills"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-1-skills"] ~* button[name="act_extraPath-1-skills"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-2-skills"] ~* button[name="act_extraPath-2-skills"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="origin-edges"] ~* button[name="act_origin-edges"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="role-edges"] ~* button[name="act_role-edges"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="society-edges"] ~* button[name="act_society-edges"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-1-edges"] ~* button[name="act_extraPath-1-edges"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-2-edges"] ~* button[name="act_extraPath-2-edges"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="origin-story"] ~* button[name="act_origin-story"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="role-story"] ~* button[name="act_role-story"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="society-story"] ~* button[name="act_society-story"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-1-story"] ~* button[name="act_extraPath-1-story"], 
.colorOverHide[value="fulgurtech"] ~* .pathTabsToggle[value="extraPath-2-story"] ~* button[name="act_extraPath-2-story"],

.colorOverHide[value="fulgurtech"] ~* .weaponTabsToggle[value="weapon1-traits"] ~ * button[name="act_weapon1-traits"], 
.colorOverHide[value="fulgurtech"] ~* .weaponTabsToggle[value="weapon2-traits"] ~ * button[name="act_weapon2-traits"], 
.colorOverHide[value="fulgurtech"] ~* .weaponTabsToggle[value="weapon3-traits"] ~ * button[name="act_weapon3-traits"], 
.colorOverHide[value="fulgurtech"] ~* .weaponTabsToggle[value="weapon1-description"] ~ * button[name="act_weapon1-description"], 
.colorOverHide[value="fulgurtech"] ~* .weaponTabsToggle[value="weapon2-description"] ~ * button[name="act_weapon2-description"], 
.colorOverHide[value="fulgurtech"] ~* .weaponTabsToggle[value="weapon3-description"] ~ * button[name="act_weapon3-description"],

.colorOverHide[value="fulgurtech"] ~* .armorTabsToggle[value="armor1-traits"] ~ * button[name="act_armor1-traits"], 
.colorOverHide[value="fulgurtech"] ~* .armorTabsToggle[value="armor2-traits"] ~ * button[name="act_armor2-traits"], 
.colorOverHide[value="fulgurtech"] ~* .armorTabsToggle[value="armor3-traits"] ~ * button[name="act_armor3-traits"], 
.colorOverHide[value="fulgurtech"] ~* .armorTabsToggle[value="armor1-description"] ~ * button[name="act_armor1-description"], 
.colorOverHide[value="fulgurtech"] ~* .armorTabsToggle[value="armor2-description"] ~ * button[name="act_armor2-description"], 
.colorOverHide[value="fulgurtech"] ~* .armorTabsToggle[value="armor3-description"] ~ * button[name="act_armor3-description"],

.colorOverHide[value="fulgurtech"] ~* .cRTabsToggle[value="cr01-traits"] ~ * button[name="act_cr01-traits"], 
.colorOverHide[value="fulgurtech"] ~* .cRTabsToggle[value="cr02-traits"] ~ * button[name="act_cr02-traits"], 
.colorOverHide[value="fulgurtech"] ~* .cRTabsToggle[value="cr03-traits"] ~ * button[name="act_cr03-traits"], 
.colorOverHide[value="fulgurtech"] ~* .cRTabsToggle[value="cr01-description"] ~ * button[name="act_cr01-description"], 
.colorOverHide[value="fulgurtech"] ~* .cRTabsToggle[value="cr02-description"] ~ * button[name="act_cr02-description"], 
.colorOverHide[value="fulgurtech"] ~* .cRTabsToggle[value="cr03-description"] ~ * button[name="act_cr03-description"],

.colorOverHide[value="fulgurtech"] ~* .cITabsToggle[value="ci01-traits"] ~ * button[name="act_ci01-traits"], 
.colorOverHide[value="fulgurtech"] ~* .cITabsToggle[value="ci02-traits"] ~ * button[name="act_ci02-traits"], 
.colorOverHide[value="fulgurtech"] ~* .cITabsToggle[value="ci03-traits"] ~ * button[name="act_ci03-traits"], 
.colorOverHide[value="fulgurtech"] ~* .cITabsToggle[value="ci01-description"] ~ * button[name="act_ci01-description"], 
.colorOverHide[value="fulgurtech"] ~* .cITabsToggle[value="ci02-description"] ~ * button[name="act_ci02-description"], 
.colorOverHide[value="fulgurtech"] ~* .cITabsToggle[value="ci03-description"] ~ * button[name="act_ci03-description"]{
	background-color: #001715;
	border-color: #008D88;
	color: #41FCF6;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .singlePath .pathTabContent .pathRelatedEdge,

.colorOverHide[value="fulgurtech"] ~* .singlePath .pathTabContent .pathRelatedEdge{
    margin-bottom: 2px;
    height: 22px;
    width: 100%;
    background: #001715;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .pseudoBody .pseudoDisplay .boxPoint,

.colorOverHide[value="fulgurtech"] ~* .pseudoBody .pseudoDisplay .boxPoint{
    border: 1px solid #008d8800;
    width: 63px;
    height: 40px;
    background: #003331;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .boxPoints .boxPointsTitle,

.colorOverHide[value="fulgurtech"] ~ * .boxPoints .boxPointsTitle {
    font-weight: normal;
    letter-spacing: 1px;
    margin-top: 3px;
    color: #59fffa;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .animaRelatedApproaches .boxPoint,

.colorOverHide[value="fulgurtech"] ~* .animaRelatedApproaches .boxPoint{
    background: #001715;
    border: 1px solid #008D88;
    width: 66px;
    height: 40px;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .animaRelatedApproaches .boxPoints .boxPointsTitle,

.colorOverHide[value="fulgurtech"] ~ * .animaRelatedApproaches .boxPoints .boxPointsTitle {
    font-weight: normal;
    letter-spacing: 1px;
    margin-top: 3px;
    color: #59fffa;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .animaRelatedApproaches .boxPoints .boxPoint input,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .boxPoints .boxPoint input,

.colorOverHide[value="fulgurtech"] ~ * .animaRelatedApproaches .boxPoints .boxPoint input,
.colorOverHide[value="fulgurtech"] ~ * .boxPoints .boxPoint input{
    color: #33FFF8;
    font-size: 20px;
    font-weight: normal; 
    width: 66px;  
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .animaStartingHP .boxPoints .boxPoint,

.colorOverHide[value="fulgurtech"] ~ * .animaStartingHP .boxPoints .boxPoint{
    background: #00ccc5;
    border: 1px solid #008D8800;
    width: 66px;
    height: 28px;
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .animaStartingHP .boxPoints .boxPoint input,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .animaStartingHP .boxPoints .boxPoint input::placeholder,

.colorOverHide[value="fulgurtech"] ~ * .animaStartingHP .boxPoints .boxPoint input,
.colorOverHide[value="fulgurtech"] ~ * .animaStartingHP .boxPoints .boxPoint input::placeholder {
    color: #001715;
    font-size: 23px;
    font-weight: bold;
    opacity: 1;  
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponTitle,

.colorOverHide[value="fulgurtech"] ~ * .inputWeaponTitle{
    opacity: .8;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputPathName,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .quantumPower .inputPathName,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponTitle,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponHeader .inputWeaponName,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponHeader .inputWeaponEnhancement,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponHeader .inputWeaponEnhancement + div,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .names input,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .target div,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .traitName,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .traitValue,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .modifierTitle,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .modifierValue .modifierAdding,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .modifierValue .modifierNumber,

.colorOverHide[value="fulgurtech"] ~* .inputPathName,
.colorOverHide[value="fulgurtech"] ~ * .inputWeaponTitle,
.colorOverHide[value="fulgurtech"] ~ * .weaponHeader .inputWeaponName,
.colorOverHide[value="fulgurtech"] ~ * .weaponHeader .inputWeaponEnhancement,
.colorOverHide[value="fulgurtech"] ~ * .weaponHeader .inputWeaponEnhancement + div,
.colorOverHide[value="fulgurtech"] ~ * .quantumPower .inputPathName,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .target div,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay .modifierTitle,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay .modifierValue .modifierAdding,
.colorOverHide[value="fulgurtech"] ~ * .customRoll .customRollContainer .defaultRollingDisplay .modifierValue .modifierNumber,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .basicModeTitle,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .inputAptitudeModeName,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .inputAptitudeauxiliaryModeName,
.colorOverHide[value="fulgurtech"] ~ * .basicLabel,
.colorOverHide[value="fulgurtech"] ~ * .aptitudeModes .aptitudeProxyLevel .aptitudeProxyLevelHeader{
    color: #41FCF6;    
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .inputPathName::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .quantumPower .inputPathName::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .inputWeaponTitle::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponHeader .inputWeaponName::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponHeader .inputWeaponEnhancement::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponHeader .inputWeaponEnhancement + div::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .names input::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .target div::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .traitName::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .traitValue::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .modifierTitle::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .modifierValue .modifierAdding::placeholder,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay .modifierValue .modifierNumber::placeholder,

.colorOverHide[value="fulgurtech"] ~* .inputPathName::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .inputWeaponTitle::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .weaponHeader .inputWeaponName::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .weaponHeader .inputWeaponEnhancement::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .weaponHeader .inputWeaponEnhancement + div::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .quantumPower .inputPathName::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .names input::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .targetNumber::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .target div::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitName::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay.singleCustomRoll .traitValue::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay .modifierTitle::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRollContainer .defaultRollingDisplay .modifierValue .modifierAdding::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .customRoll .customRollContainer .defaultRollingDisplay .modifierValue .modifierNumber::placeholder,
.colorOverHide[value="fulgurtech"] ~ * .pseudoDisplay .customRollContainer .defaultRollingDisplay.singleCustomRoll .modifierNumber::placeholder{
    color: #41FCF6;  
    opacity: .5;  
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .characterName,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .targetNumber,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .traitName,

.colorOverHide[value="fulgurtech"] ~ * .defaultRollingDisplay.singleCustomRoll .characterName,
.colorOverHide[value="fulgurtech"] ~ * .defaultRollingDisplay.singleCustomRoll .targetNumber,
.colorOverHide[value="fulgurtech"] ~ * .defaultRollingDisplay.singleCustomRoll .traitName{
    font-weight: normal;
}
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .defaultRollingDisplay.singleCustomRoll .target .targetSelected[value="1"] ~ div
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponTagsSection,

.colorOverHide[value="fulgurtech"] ~ * .weaponTagsSection {  
    border-color: #008d88;
    background-color: #000000;   
} 


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * input[type="checkbox"].expander + span::after,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .repcontainer .singlePathContact input[type="checkbox"].expander + span::after, 

.colorOverHide[value="fulgurtech"] ~ * input[type="checkbox"].expander + span::after,
.colorOverHide[value="fulgurtech"] ~ * .repcontainer .singlePathContact input[type="checkbox"].expander + span::after{
    color: #008D88;
}
...
.colorOverHide[value="fulgurtech"] ~ * .arenaTitle .primaryColorBackground{
    background: #002726;
    color: #56d7d3;
    font-weight: 600;
    border: 1px #27a09b solid;
}



.colorOverHide[value="fulgurtech"] ~ * .skillTricks select,
.colorOverHide[value="fulgurtech"] ~ * .skillTricks .select-icon,
.colorOverHide[value="fulgurtech"] ~ * .health select,
.colorOverHide[value="fulgurtech"] ~ * .health .select-icon,
.colorOverHide[value="fulgurtech"] ~ * .aspirations select,
.colorOverHide[value="fulgurtech"] ~ * .aspirations .select-icon  {
    background-color: #00403E;
    color: #59fffa;
}


.colorOverHide[value="fulgurtech"] ~ * .injuryValue{
    color: #59fffa 
}

.colorOverHide[value="fulgurtech"] ~ * .pathContactName,
.colorOverHide[value="fulgurtech"] ~ * .pathContactTag,
.colorOverHide[value="fulgurtech"] ~ * .singlePathContact .expanderContainer{
    background: #001715;
    border-color: #008d88;
    border-radius: 0px;
    color: #28ccc7;
...
.colorOverHide[value="fulgurtech"] ~ * .pathContacts .pathContactName:hover, 
.colorOverHide[value="fulgurtech"] ~ * .pathContacts .pathContactName:active, 
.colorOverHide[value="fulgurtech"] ~ * .pathContacts .pathContactName:focus {
...
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponDescriptionTab,
.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .armorDescriptionTab,
  
.colorOverHide[value="fulgurtech"] ~ * .weaponDescriptionTab,
.colorOverHide[value="fulgurtech"] ~ * .armorDescriptionTab {
      border-bottom-color: #008D88;
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .weaponTag .expandedArea,

.colorOverHide[value="fulgurtech"] ~ * .weaponTag .expandedArea{
    max-width: calc(95% - 0px);
    min-width: calc(95% - 0px);
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .armorTag .expandedArea,

.colorOverHide[value="fulgurtech"] ~ * .armorTag .expandedArea{
    max-width: calc(95% - 0px);
    min-width: calc(95% - 0px);
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleCustomRoll.defaultRollingDisplay .writingROLL,

.colorOverHide[value="fulgurtech"] ~ * .singleCustomRoll.defaultRollingDisplay .writingROLL{
    color: #001715;
    font-size: 17px;
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~ * .singleCustomRoll.defaultRollingDisplay .numberHider,

.colorOverHide[value="fulgurtech"] ~ * .singleCustomRoll.defaultRollingDisplay .numberHider{
    background: rgb(89, 255, 250);
}



.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .circumstExpanded .otherTraits .input-label,

.colorOverHide[value="fulgurtech"] ~* .circumstExpanded .otherTraits .input-label{    
    color: #41FCF6;
    transition: 1s;    
}


.colorOverHide[value="default"] + .selectedTier[value="anima"] ~* .circumstExpanded .otherTraits .inputLine,

.colorOverHide[value="fulgurtech"] ~* .circumstExpanded .otherTraits .inputLine{    
    border-bottom: 1px solid #008D88;
    color: #24DBD6;
}
...
.colorOverHide[value="fulgurtech"] ~* .expanderFlag[value="1"] ~ .megaAttributteExpandedArea {
    border-bottom-color: #27a09b;
}



.colorOverHide[value="fulgurtech"] ~* .skill .inputLine {
...
.colorOverHide[value="fulgurtech"] ~ * .arenaTitle .primaryColorBackground,
.colorOverHide[value="fulgurtech"] ~ * .megaArenaTitle .primaryColorBackground{
    background: #002726;
    color: #56d7d3;
    font-weight: 600;
    border: 1px #27a09b solid;
...
.colorOverHide[value="fulgurtech"] ~ * .aspirations select,
.colorOverHide[value="fulgurtech"] ~ * .aspirations .select-icon,
.colorOverHide[value="fulgurtech"] ~ * .transformation .traitHeader select,
.colorOverHide[value="fulgurtech"] ~ * .transformation .traitHeader .select-icon  {
    background-color: #00403E;
    color: #59fffa;
}
...
.colorOverHide[value="fulgurtech"] ~ * .pathContactName:placeholder-shown{
    color: #41fcf6;
}

.colorOverHide[value="fulgurtech"] ~ * .pathContactName::placeholder{
    color: #41fcf6;
    opacity: .5;
}
...
.colorOverHide[value="fulgurtech"] ~ * .pathRelatedSkill {
    background: #002f2c;
    border-color: #00fff63d;
    border-radius: 0px;
    color: #41fcf6;
    font-weight: 500;
}
...
.colorOverHide[value="fulgurtech"] ~ * .buttonsSliderPath a{
    color: #33bbb6;
    border-color: #4b9996;
    border-radius: 0px;
    position: relative;
...
.colorOverHide[value="fulgurtech"] ~ * .sourceDots .line {
    border-color: #239591;
}


.colorOverHide[value="fulgurtech"] ~ * .fortes .input-label{
    color: #59fffa;
    font-family: goldman;
}

.colorOverHide[value="fulgurtech"] ~ * .fortes .forte button{
    width: 26px;
    margin-top: -1px;
}

.colorOverHide[value="fulgurtech"] ~ * .fortes .forte button span{
    margin-top: 1px;
    height: 7px;
    width: 100%;
    transform: none;
...
.colorOverHide[value="fulgurtech"] ~ * .aptitude {
    background: #00403e2e;
    border-color: #41fcf652;
}


.colorOverHide[value="fulgurtech"] ~ * .inputAptitudeModeName div{
    margin-bottom: -4px;
}

.colorOverHide[value="fulgurtech"] ~ * .expanderFlag[value="1"] ~ .aptitudeModeExpandedArea{
    border-top-color: #004846;
    border-bottom-color: #004846;
}
...
.colorOverHide[value="fulgurtech"] ~ * .TCSheet .TCSecondaryAptitude .customRepeating input[value="innate"] ~ .aptitude {
    background: #001e1c;
}


.colorOverHide[value="fulgurtech"] ~ * .TCSheet .TCSecondaryAptitude .customRepeating input[value="innate"] ~ * .basicMode {
    border-color: #008D88;
  }



.colorOverHide[value="fulgurtech"] ~* .TCSheet .TCSecondaryAptitude .customRepeating input[value="innate"] ~* .pathLabel{
    background-color: #59fffa;
    color: black;    
}
...
.colorOverHide[value="fulgurtech"] ~* .TCSheet .TCSecondaryAptitude .customRepeating input[value="priaptitude"] ~* .pathLabel{
    background-color: #01423e;
    color: #59fffa;
    border: 1px solid #1daaa5;   
}



.colorOverHide[value="fulgurtech"] ~* .TCSheet .TCSecondaryAptitude .customRepeating input ~* .primaryColorFont,
.colorOverHide[value="fulgurtech"] ~* .TCSheet .TCSecondaryAptitude .customRepeating input[value="priaptitude"] ~* .primaryColorFont{
    color:#59fffa;
}



.colorOverHide[value="fulgurtech"] ~* .TCSheet .TCSecondaryAptitude .customRepeating input[value="secaptitude"] ~* .pathLabel{
    background-color: #01423e;
    color: #2cf7f0;
    border: 1px solid #156562;
}



.colorOverHide[value="fulgurtech"] ~* .TCSheet .TCSecondaryAptitude .customRepeating input[value="secaptitude"] ~* .primaryColorFont{
    color:#59fffa;
}
...
.readerTrait .tier .inputLine option.optionTitle{
    font-size: 14px;
    font-weight: bolder;
}

.tier .inputLine option:disabled{
...
.customRepeating .title2{
    border-right: none;
 }

.selectableTitle .title2{
    border-left: none;
}
...
.aptitudeName[value="clairsentience"] ~* .basicModeClairsentience,
...
.primaryAptitudeName[value="clairsentience"] ~* .basicModeClairsentience,
...
.secondaryAptitudeName[value="clairsentience"] ~* .basicModeClairsentience,
...
.aptitudeModeExpandedArea input[type="checkbox"]::before{
    height: 9px;
...
.auxiliaryModeSelected[value="adaptation"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="psychomorph"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="transmogrify"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="psychometry"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="psycholocat"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="psychocognit"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="electromanipul"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="photokinesis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="technokinesis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="thermokinesis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="telekinesis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="perikinesis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="energetics"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="fundamentals"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="transmutation"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="rapport"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="mindshare"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="psychbending"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="translocation"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="transmassion"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="transportal"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="iatrosis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="augendis"] ~* .inputAptitudeauxiliaryModeName:hover,
.auxiliaryModeSelected[value="algesis"] ~* .inputAptitudeauxiliaryModeName:hover{
    background: white;
    border: 1px solid #ccc;
}
...
.injury-selectType[value=""] ~ input.injury-checkbox{
    opacity: .5;
    pointer-events: none;
}


.injury-selectType[value=""] ~ input.injury-name{
    opacity: .3;
}

.pseudoBody .pseudoDisplay .repeatingContainer .traitHeader .injury-selectType[value=""] ~ input[type="checkbox"],
.pseudoBody .pseudoDisplay .repeatingContainer .traitHeader .injury-selectType[value=""] ~ input[type="checkbox"]:checked{
    background-color:#979797;
    border: 2px solid #979797;
}

.injury-selectType[value=""] ~ input[type="checkbox"]::before {
    background-color: transparent;
}


.pTwinSection .sheet-col .health .injury-selectType[value=""] ~ select.secondaryColorBackground{
    background-color: #dfdfdf;
    opacity: .9;
}
...
.pseudoBody .pseudoDisplay .TCPaths input.selectedPathStatus[value="active"] + .singlePath .pathStatus{
    width: 53px;
    transition: .5s;
}

.pseudoBody .pseudoDisplay .TCPaths input.selectedPathStatus[value="suspended"] + .singlePath .pathStatus{
    color: #000000a6;
    background: #d2d2d2;
...
.pseudoBody .pseudoDisplay .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath{
    background-color: #D9D9D9;
    transition: 1s;
}

.pseudoBody .pseudoDisplay .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath .pathStatus{
    border-color: #00000045;
    color: #000000a6;
}

.pseudoBody .pseudoDisplay .TCPaths input.selectedPathStatus[value="revoked"] + .singlePath .pathLabel{
    background: #717171;
    color: white;
}
...
.pathTabsToggle[value="origin-story"] ~* .storyTab,
.pathTabsToggle[value="role-story"] ~* .storyTab,
.pathTabsToggle[value="society-story"] ~* .storyTab,
.pathTabsToggle[value="extraPath-1-story"] ~* .storyTab,
.pathTabsToggle[value="extraPath-2-story"] ~* .storyTab{
    display: flex;
    flex-direction: column;
}
...
.pathTabsToggle[value="origin-story"] ~* button[name="act_origin-story"],
.pathTabsToggle[value="role-story"] ~* button[name="act_role-story"],
.pathTabsToggle[value="society-story"] ~* button[name="act_society-story"],
.pathTabsToggle[value="extraPath-1-story"] ~* button[name="act_extraPath-1-story"],
.pathTabsToggle[value="extraPath-2-story"] ~* button[name="act_extraPath-2-story"]{
    background-color: #F5F6F7;
    border: solid;
    border-width: 1px;
    border-color:#B9B9B9;
...
.singlePathContact .expanderContainer{
    border: 1px solid #ccc;    
    border-radius: 3px;
    background-color: white;
    font-size: 13px;
...
.singlePathContact .expanderContainer span{
    color: #979797;
}

.singlePathContact .contactStatus[value=""] ~* .expanderContainer{
    display: none;
}
...
.singlePathContact .expanderFlagModal[value="1"] ~ .pathContactHeader, 
.singlePathContact .expanderFlagModal[value="1"] ~ .expandedArea {
    z-index: 3;
    background: white;
  }
...
.singlePathContact .expandedArea {
	max-width: 193.6%;
	min-width: 193.6%;
    max-height: 150px;	       
}
...
.singlePathContact .expanderFlagModal[value="0"] ~ .expandedArea,
.singlePathContact .expanderFlagModal[value="1"] ~ .expandedArea{
    top: auto;
    margin-top: 27px;
}

.singlePathContact input[type="checkbox"].expander + span::after {
    color: #828282;
} 
...
.repcontainer .singlePathContact .expanderFlagModal[value="1"] ~ .pathContactHeader, 
.repcontainer .singlePathContact .expanderFlagModal[value="1"] ~ .expandedArea {
    z-index: 3;
    background: white;
  }
...
.repcontainer .singlePathContact .expandedArea {
	max-width: 193.6%;
	min-width: 193.6%;
    max-height: 150px;	       
}
...
.repcontainer .singlePathContact .expanderFlagModal[value="0"] ~ .expandedArea,
.repcontainer .singlePathContact .expanderFlagModal[value="1"] ~ .expandedArea{
    top: auto;
    margin-top: 27px;
}

.repcontainer .singlePathContact input[type="checkbox"].expander + span::after {
    color: #828282;
} 
...
.singlePath .pathTabContent .storyTab textarea{
    height: 250px;
    max-height: 250px;
    min-height: 250px;
}
...
.headOtherTier .npc-traits,
.headOtherTier .conditions,
.headOtherTier .notes{
    width: 100%;
}

.TCSheet .headOtherTier .sheet-col.otherTierConditions{
    margin-right: 0px;
}
...
.npc-traits .technologyTech .boxPoints {
   margin-top: -2px;  
}
...
.npc-traits .npcPools .npcPool select[name="attr_equipment_size"] option[value="0"]{
    display:none;    
}
...
.npcPools .transportFT .input-label{
    margin-right: 5px;
}
...
.selectedTech[value="hard"] ~* .npc-traits .npcPools .npcPool .transportFT div input.primaryColorFont{
    color:transparent;
    opacity: 0;
}
...
.npc-traits .npcPool.technologyType {
    margin-top: 12px;
}

.npc-traits .npcPool.transportSize {
    margin-top: 10px;
}
...
.npc-traits .equipmentTypeRange {
    margin-top: 10px;
    margin-bottom: -5px;
}

.npc-traits .equipmentArmorResistant {
    margin-top: 20px;
    margin-bottom: -5px;
}

.npc-traits .equipmentArmorResistant .npcEnhancements {
    height: 10px;
}

.npc-traits .equipmentArmorResistant .input-label.alt {
    font-size: 13px;
    font-weight: 550;
}

.npc-traits .equipmentArmorResistant input[type="checkbox"] {
   margin-right: 4px;
   margin-top: -2px;
}


.headerStatsWeaponType{
    margin-top: 16px;
}


.singleArmor .weaponHeader .headerStatsWeaponType input{
    text-transform: uppercase;
    font-style: normal;
    font-size: 14px;
    font-weight: 550;
...
.singleArmor .weaponHeader .headerStatsWeaponType input:active, 
.singleArmor .weaponHeader .headerStatsWeaponType input:hover, 
.singleArmor .weaponHeader .headerStatsWeaponType input:focus {
    background-color: white;
    border: 1px solid #ccc;     
  }
...
.headerStatsWeaponType div.primaryColorFont{
    font-size: 11px;      
}


.selectedTier[value="equipment"] ~* button[name="act_equipments"]{
    display: none;
}

.selectedTier[value="equipment"] ~* .rollButtons{
    display: none;
}


.selectedTech[value="noetic"] ~* .equipment .fmtTo{
    display: flex;
}

.selectedTech[value="noetic"] ~* .equipment .builtBy{
    display: none;
}


.selectedTech[value="hard"] ~* .equipment .builtBy{
   display: flex;
}

.equipmentRange select + .input-label{
    margin-left: 6px;
}


/* ++++ - Fim Equipment Adjustments - +++++ */



/* ++++ - V.A.R.G Adjustments - +++++ */

.reader.varg .inputWeaponEnhancementConteiner{
   margin-right: 5px;  
}


.reader.varg .inputWeaponEnhancementConteiner input{
    width: 25px;  
}

.otherTierUniqueAbility textArea{
    /* overflow: hidden; */
    resize: none;
    resize: none;
    text-align: justify;
...
/* .otherTierUniqueAbility textArea:hover{
    overflow: initial;    
} */

.npc-traits .npcPool.transportSize.lifeSuportDays  {
    margin-top: 20px;
}


.transportSize.baseSpeed{
    margin-bottom: 25px;
}

.otherTierUniqueAbility .title2{
    margin-bottom: 7px;
}


.selectedTier[value="varg"] ~* button[name="act_equipments"]{
    display: none;
}

.selectedTech[value="noetic"] ~ * .varg .fmtTo {
    display: flex;
}

.selectedTech[value="noetic"] ~ * .varg .builtBy {
    display: none;
}

.selectedTier[value="varg"] ~* .rollButtons .hider[value="1"] + div{
    height: 32px;
}


.health .repcontainer.editmode .repitem[data-reprowid="----Rep-Vinj---ID-00"] .itemcontrol,
.health .repcontainer.editmode .repitem[data-reprowid="----Rep-Vinj---ID-01"] .itemcontrol,
.health .repcontainer.editmode .repitem[data-reprowid="----Rep-Vinj---ID-02"] .itemcontrol,
.health .repcontainer.editmode .repitem[data-reprowid="----Rep-Vinj---ID-03"] .itemcontrol{
    display: none;
}

/* ++++ - Fim V.A.R.G Adjustments - +++++ */
...
.animaSkillEnhacNumber.boxPoints{
    width: 60px;
    height: 28px;   
}

.pseudoDisplay .animaSkillEnhacNumber.boxPoints input{
    font-size: 20px;
    font-weight: bold;
    width: 61px;
}

.animaSkillEnhacNumber.boxPoints input:hover{
    padding-left: 30%;
}

.TCAnimaAspects .title2{
    margin-bottom: 3px;

}

.TCAnimaAspects .tagAspect{
    width: 50px;
}
...
.animaApproaches .arenas{
    width: initial;     
}

.animaApproaches .arena{
    width: 100%;
    margin-top: 10px;    
}

/* ++++ - FIM APPROACHES Anima - +++++ */
...
.anima .animaHealth .boxPoint{
    width: 70px;
    height: 50px;
}

.anima .animaHealth .boxPoint input{
    font-size: 24px;
}

.animaHealth .boxPoints{
    margin-top: 20px;
    width: 67%;
}

.anima .animaHealth .boxPoints input{   
    font-weight: bold;
    width: 2.9em;
}
...
.anima .pathHeader input{
    font-size: 24px;
}

.anima .pathSuperGroup{
    height: initial;
}

.anima .pathTabButtons{
    width: 95%;
}

.anima .pathTabButtons button{
    width: 50%;
}
...
.TCAnimaAspects .repcontainer.editmode .repitem[data-reprowid="----Rep-ASpc---ID-00"] .itemcontrol .repcontrol_del,
.TCAnimaAspects .repcontainer.editmode .repitem[data-reprowid="----Rep-ASpc---ID-01"] .itemcontrol .repcontrol_del{
    display: none;
}



.animaAspect .input-label{
   font-size: 15px;
}

.animaAspect textarea,
.animaCallInTheGuild textarea{
    resize: none;
    height: 55px;
    border-radius: 0px;
    padding: 4px;
...
.animaAspect textarea:hover,
.animaCallInTheGuild textarea:hover{
    background: #fbfbfb;
}

.anima .animaCallInTheGuild textarea{
    height: 248px;
}

.TCPaths.anima .animaRelatedApproaches .boxPoints{
   width: 100%;
   margin-top: 0px;
}

.TCPaths.anima .animaRelatedApproaches .boxPoint{
    width: 68px;
    height: 40px;
}

.TCPaths.anima .animaRelatedApproaches .boxPoint input{
    font-size: 19px;
    font-weight: bold;
}
...
.animaStartingHP .readerTrait{
   justify-content: initial;
   flex-direction: column;
 }

 .animaStartingHP .boxPoints{
    width: initial;
    align-self: center;
    margin-top: -34px;
}

.animaStartingHP .boxPoint{
    width: 68px;
    height: 30px;
}

.anima .animaStartingHP .boxPoint input{
    width: 3.5em;
    font-weight: bold;
}

.animaStartingHP .boxPoint input:hover{
   width: 66px;
}

.animaStartingEquipments{
    margin-top: 42px;
}
...
.animaQuestPhase .input-label{
   font-size: 15px;
}

.animaQuestPhase textarea{
    resize: none;
    height: 40px;
    color: #555;
    border: 1px solid #ccc;
...
.anima .quantumPowerTraitsHeader{
    height: 102px;
}

.anima .quantumPowerTraitsTab .inputLine{
    text-align: center;
}

.anima .expanderFlag[value="1"] ~ * .quantumPowerExpandedArea {
    height: 303px;
    overflow: visible;
}

.anima .quantumPowerTabContent {
    height: 270px;
}

.anima .quantumPowerTagsContainer {
    height: 165px;
    padding-top: 2px;
}
...
.TCAnimaAspects.anima .animaBuffName input{
    padding-left: 10px;
    text-align: left;
}

.TCAnimaAspects.anima .quantumPower .animaBuffLevel .traitHeader{
    width: 100%;
    height: 30px;
    padding-left: 0px;
    padding-right: 0px;
...
.TCAnimaAspects.anima .quantumPower .animaBuffLevel .traitHeader .dots{
    padding-top: 0px;
    margin-top: -4px;
}
...
.animaBuffExpander span{
   color: #717171;
}

.quantumPowerTagsContainer .animaBuffLevel .expandedArea {
...
.animaBuffLevel .expanderFlagModal[value="0"] ~ .expandedArea,
.animaBuffLevel .expanderFlagModal[value="1"] ~ .expandedArea{
    top: auto;
    margin-top: -8px;
}

.TCAnimaAspects.anima .gt-5{
    display: flex;
}
...
.animaEffects .input-label,
.animaDescription .input-label{
   font-size: 15px;
}

.animaEffects textarea,
.animaDescription textarea{
    resize: none;    
    color: #555;
    border: 1px solid #ccc;
    border-radius: 3px;   
...
.anima .quantumPowerDescriptionTab{
    padding: 0px;
    padding-left: 15px;
    padding-right: 15px;
}
...
.inputWeaponEnhancementConteiner div{
    color: #5E5E5E;
    font-size: 11px;
    margin-left: 3px;
}
...
.singleWeapon .weaponTabButtons button:hover{
    background-color: #0000000a;
    transition: background-color 0s;
}
...
.singleArmor .weaponHeader .inputWeaponEnhancement.formatable{   
    width: 68px;          
}
...
.sheetform .charactersheet .pseudoBody .pseudoDisplay .defaultRollingDisplay select option{
...
.sheetform .charactersheet .pseudoBody .pseudoDisplay .defaultRollingDisplay.modalRoll .modifierTitle{
    color: #4B4B4B!important;
}

.sheetform .charactersheet .pseudoBody .pseudoDisplay .defaultRollingDisplay.modalRoll .modifierAdding{
...
.pseudoDisplay .defaultRollingDisplay.modalRoll .modifierNumber{    
    color: #656565 !important;   
}
...
.defaultRollingDisplay.modalRoll .rollEndingSection{   
