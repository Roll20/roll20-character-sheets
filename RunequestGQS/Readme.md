...
## 08.04.2019 Version 
	...
	fix some users reporting  issues with power rune labes. Replaced graphics for power runes
	...
	Added support to add turn order entries based on missle weapon strike ranks.
