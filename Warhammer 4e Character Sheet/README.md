...
NEW - Condition Tracking fully implentantion, now adds up Multiple Conditions correctly as per the rule book. Meaning only one (highest) condition will be added to the roll template Automatically. Also changed the setting dropdown description to clarify this.
...
- Talents now have a roll template and button which displays their info in chat.
