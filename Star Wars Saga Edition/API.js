...
var attr = [ // Attributes
    ...
    { name: "Level", current: 0, max: ""},
    { name: "BAB", current: 0, max:  ""},
    { name: "FP", current: 5, max: 5 },
    { name: "DP", current: 0, max: "" },
    { name: "DarkSideScore", current: 0, max: "" } ,
    { name: "STR", current: 8, max: ""} ,
    { name: "DEX", current: 8, max: "" } ,
    { name: "CON", current: 8, max: "" } ,
    { name: "INT", current: 8, max: "" } ,
    { name: "WIS", current: 8, max: "" } ,
    { name: "CHA", current: 8, max: "" },,
...
// For Initiative, remove &{Tracker} if you are not using the Turn tracker.
    ...
    {name: "Acrobatics", description: "",action: "%{Acrobatics}", istokenaction: false},  
    {name: "Climb", description: "", action: "%{Climb}", istokenaction: false},  
    {name: "Deception",description: "",action: "%{Deception}", istokenaction: false},  
    {name: "Endurance",description: "",action: "%{Endurance}", istokenaction: false},  
    {name: "Gather-Information",description: "",action: "%{GatherInformation}", istokenaction: false},  
    {name: "Initiative",description: "",action: "%{Initiative} ${tracker}", istokenaction: true},  
    {name: "Jump",description: "",action: "%{Jump}", istokenaction: false},  
    {name: "Knowledge-Bureaucracy",description: "",action: "%{Knowledge-Bureaucracy}", istokenaction: false},  
    {name: "Knowledge-GalacticLore",description: "",action: "%{Knowledge-GalacticLore}", istokenaction: false},  
