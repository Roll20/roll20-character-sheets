...
gcloud storage rsync --project=roll20-actual ./ "gs://roll20-cdn/$CDN_SHEETS_FOLDER/$CURRENT_DIR" --delete-unmatched-destination-objects --cache-control='no-cache' --exclude=".*\.css$|.*\.html$|.*\.md$|.*\.sh$|TODO$"
