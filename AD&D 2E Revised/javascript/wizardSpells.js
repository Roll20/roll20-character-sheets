...
wiz6['Chain Lightning'] = {
    'level': 'Level 6 Wizard',
    'school': 'Evocation',
    'range': '[[5*[[@{level-wizard}]]+40]] yards',
    'duration': 'Instantaneous',
    'aoe': 'Special',
    'components': 'V, S, M',
    'cast-time': '5',
    'saving-throw': '½',
    'materials': 'A bit of fur, a piece of amber, glass, or crystal rod, and [[@{level-wizard}]] silver pins',
    'reference': 'PHB p. 221',
    'damage': '[[ [[{{[[@{level-wizard}]],0}>1}*1]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1]])\n[[ [[{{[[@{level-wizard}]],0}>2}*2]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-1]])\n[[ [[{{[[@{level-wizard}]],0}>3}*3]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-2]])\n[[ [[{{[[@{level-wizard}]],0}>4}*4]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-3]])\n[[ [[{{[[@{level-wizard}]],0}>5}*5]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-4]])\n[[ [[{{[[@{level-wizard}]],0}>6}*6]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-5]])\n[[ [[{{[[@{level-wizard}]],0}>7}*7]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-6]])\n[[ [[{{[[@{level-wizard}]],0}>8}*8]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-7]])\n[[ [[{{[[@{level-wizard}]],0}>9}*9]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-8]])\n[[ [[{{[[@{level-wizard}]],0}>10}*10]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-9]])\n[[ [[{{[[@{level-wizard}]],0}>11}*11]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-10]])\n[[ [[{{[[@{level-wizard}]],0}>12}*12]]d6]] (strike #[[{12,[[@{level-wizard}]]}kl1-11]])',
...
wiz8['Serten\'s Spell Immunity'] = {
    ...
    'damage-type': '',
    'healing': '',
    'effect': 'By use of this spell, the wizard is able to confer virtual immunity to certain spells and magical attack forms upon those he touches. Up to [[floor([[@{level-wizard}]]/4)]] creatures can be protected by the Serten’s spell immunity spell; however, if more than one is protected, the duration of the protection is divided among the protected creatures.\n&emsp;For example, a 16th-level wizard can cast the spell upon one creature and it will last 16 turns, or place it upon two creatures for eight turns, or four creatures for four turns.) The protection gives a bonus to saving throws, according to spell type and level, as shown in the following table.\n**Spell Level&emsp;Wizard Spell&emsp;Priest Spell**\n1st–3rd&emsp;+9&ast;&emsp;+7\n4th–6th&emsp;+7&emsp;+5\n7th–8th&emsp;+5&emsp;+3&ast;\n&ast; Includes *beguiling* effects.'
};
...
wiz8['Sink'] = {
    ...
    'range': '[[10*[[@{level-wizard}]] ]] yards',
    'duration': 'Special',
    'aoe': '1 creature or object, max [[@{level-wizard}]] cu. feet',
    'components': 'V, S',
    'cast-time': '8',
    'saving-throw': 'Special',
    'materials': '',
...
wiz8['Symbol'] = {
    ...
    'damage-type': '',
    'healing': '',
    'effect': 'A *symbol* spell creates magical runes affecting creatures that pass over, touch, or read the runes, or pass through a portal upon which the symbol is inscribed. Upon casting the spell, the wizard inscribes the symbol upon whatever surface he desires. Likewise, the spellcaster is able to place the symbol of his choice, using any one of the following:\n*Death*&emsp;One or more creatures, whose total hit points do not exceed 80, are slain.\n*Discord*&emsp;All creatures are affected and immediately fall to loud bickering and arguing; there is a 50% probability that creatures of different alignments attack each other. The bickering lasts for [[5d4]] rounds, the fighting for [[2d4]] rounds.\n*Fear*&emsp;This symbol creates an extra-strong *fear* spell, causing all creatures to save vs. spell with –4 penalties to the die roll, or panic and flee as if attacked by a *fear* spell.\n*Hopelessness*&emsp;All creatures are affected and must turn back in dejection unless they save vs. spell. Affected creatures submit to the demands of any opponent—for example, surrender, get out, etc. The hopelessness lasts for [[3d4]] turns; during this period it is 25% probable that affected creatures take no action during any round, and 25% likely that those taking action turn back or retire from battle, as applicable.\n*Insanity*&emsp;One or more creatures whose total hit points do not exceed 120 become insane and remain so, acting as if a *confusion* spell had been placed upon them, until a *heal, restoration,* or *wish* spell is used to remove the madness.\n*Pain*&emsp;All creatures are afflicted with wracking pains shooting through their bodies, causing a –2 penalty to Dexterity and a –4 penalty to attack rolls for [[2d10]] turns.\n*Sleep*&emsp;All creatures under 8+1 Hit Dice immediately fall into a catatonic slumber and cannot be awakened for [[1d12+4]] turns.\n*Stunning*&emsp;One or more creatures whose total hit points do not exceed 160 are stunned and reeling for [[3d4]] rounds, dropping anything they are holding.\n&emsp;The type of symbol cannot be recognized without being read and thus activating its effects.'
};
...
wiz8['Trap the Soul'] = {
    ...
    'cast-time': 'Special + 1',
    'saving-throw': 'Special',
    'materials': 'A gem of at least 1,000 gp value for every Hit Die or level of experience possessed by the creature to be trapped (see below)',
    'reference': 'PHB p. 245',
    'damage': '',
    'damage-type': '',
    'healing': '',
