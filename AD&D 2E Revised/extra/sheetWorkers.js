...
function setupRepeatingCalculateTotal(repeatingTotalField, repeatingFieldsToSum, repeatingName) {
    console.log(repeatingFieldsToSum);
    ...
    on(`${onChange} remove:repeating_${repeatingName}`, function(){
        TAS.repeating(repeatingName)
            .fields(allFields)
            .reduce(function(m,r) {
                ...
                console.log(m);
                return m;
            }, {total: 0}, function (m,r) {
                console.log(m);
                r[repeatingTotalField] = m.total;
            })
            .execute();
    });
}
