...
warlockRollCoutrecoups.forEach(button => {
    ...
    on(`clicked:${button}`, function(info) {
        ...
        startRoll(exec.join(" "), (results) => {
            let tD1 = results.results.rollTitre.result;
            let tD2 = results.results.rollText.result;

            let t6D6D = results.results.roll6D6.dice;
            let t6D6R = results.results.roll6D6.result;

            let t1D3 = results.results.roll1D3.result;
